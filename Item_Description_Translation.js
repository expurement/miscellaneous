    ...
    "At the end of every turn, this item attempts to badly poison the holder.":"回合结束时进入中剧毒状态",
    ...
    "Damage of moves used on consecutive turns is increased. Max 2x after 5 turns.":"每重复使用一次相同招式时，威力提升20%，重复5次后提升到最大",
    "Dusk Mane/Dawn Wings Necrozma: Ultra Burst, then Z-Move w/ Photon Geyser.":"奈克洛兹玛-黄昏之鬃/拂晓之翼携带可以究极爆发，光子喷涌升级为Z招式：焚天灭世炽光爆",
    "Each turn, holder has a 20% chance to move first in its priority bracket.":"20%几率优先使用招式",
    ...
    "Holder gains 1.3x HP from draining/Aqua Ring/Ingrain/Leech Seed/Strength Sap.":"吸取类招式、寄生种子、水流环、扎根和吸取力量的回复量提升30%",
    "Holder gains the Focus Energy effect when at 1/4 max HP or less. Single use.":"HP小于等于25%时进入易中要害状态",
    "Holder has a 10% chance to survive an attack that would KO it with 1 HP.":"受到攻击而将濒死时，10%几率保留1点HP而不陷入濒死状态",
    ...
    "Holder moves first in its priority bracket when at 1/4 max HP or less. Single use.":"HP小于等于25%时能优先攻击一次，使用后消失",
    "Holder moves last in its priority bracket.":"携带者所用招式在相同优先度内必定后出",
    "Holder wakes up if it is asleep. Single use.":"解除睡眠状态，使用后消失",
    "Holder's Attack is 1.5x, but it can only select the first move it executes.":"攻击提升50%，只能使用上场后使出的第一个招式",
    ...
    "Holder's Sp. Atk is 1.5x, but it can only select the first move it executes.":"特攻提升50%，只能使用上场后使出的第一个招式",
    "Holder's Sp. Def is 1.5x, but it can only select damaging moves.":"特防提升50%，只能使用攻击招式",
    "Holder's Speed is 1.5x, but it can only select the first move it executes.":"速度提升50%，只能使用上场后使出的第一个招式",
    ...
    "Holder's Techno Blast is Electric type.":"使高科技光炮变为电属性",
    "Holder's Techno Blast is Fire type.":"使高科技光炮变为火属性",
    "Holder's Techno Blast is Ice type.":"使高科技光炮变为冰属性",
    "Holder's Techno Blast is Water type.":"使高科技光炮变为水属性",
    ...
    "Holder's attacks without a chance to flinch gain a 10% chance to flinch.":"让不会陷入畏缩状态的招式获得10%的几率畏缩",
    "Holder's critical hit ratio is raised by 1 stage.":"击中要害阶级提升1级",
    ...
    "Holder's two-turn moves complete in one turn (except Sky Drop). Single use.":"让蓄力招式当回合直接发动效果（自由落体除外），使用后消失",
    "Holder's use of Aurora Veil, Light Screen, or Reflect lasts 8 turns instead of 5.":"让光墙、反射壁和极光幕从5回合延长至8回合",
    ...
    "If Trick Room is active, lowers holder's Speed by 1 stage. Single use.":"让宝可梦在戏法空间下速度降低1级，使用后消失",
    ...
    "If held by a Chansey, its critical hit ratio is raised by 2 stages.":"吉利蛋携带后击中要害阶级提升2级",
    ...
    "If held by a Farfetch'd, its critical hit ratio is raised by 2 stages.":"大葱鸭携带后击中要害阶级提升2级",
    ...
    "If held by a Giratina, its Ghost- and Dragon-type attacks have 1.2x power.":"骑拉帝纳携带后变为起源形态，龙属性和幽灵属性的招式威力提升20%",
    ...
    "If held by a Kommo-o with Clanging Scales, it can use Clangorous Soulblaze.":"杖尾鳞甲龙携带后可以将鳞片噪音转化成Z招式：炽魂热舞烈音爆",
    ...
    "If held by a Lycanroc forme with Stone Edge, it can use Splintered Stormshards.":"鬃岩狼人携带后可以将尖石攻击转化成Z招式：狼啸石牙飓风暴",
    ...
    "If held by a Mimikyu with Play Rough, it can use Let's Snuggle Forever.":"谜拟Q携带后可以将嬉闹转化成Z招式：亲密无间大乱揍",
    ...
    "If holder's HP is full, will survive an attack that would KO it with 1 HP. Single use.":"HP全满时受到攻击而将陷入濒死状态时会保留1点HP，使用后消失",
    "If holder's species can evolve, its Defense and Sp. Def are 1.5x.":"还能进化的宝可梦携带后，防御和特防提升50%",
    "If the holder misses because of accuracy, it raises Speed by 2 stages. Single use.":"招式因命中率影响而落空时，速度会提升2级",
    ...
    "Lunala or Dawn Wings Necrozma with Moongeist Beam can use a special Z-Move.":"露奈雅拉/奈克洛兹玛-拂晓之翼可以将暗影之光转化成Z招式：月华飞溅落灵霄",
    ...
    "Raises a random stat by 2 when at 1/4 max HP or less (not acc/eva). Single use.":"HP小于等于25%时随机提升一项能力2级，使用后消失",
    ...
    "Raises holder's Attack by 1 stage when at 1/4 max HP or less. Single use.":"HP小于等于25%时攻击提升1级，使用后消失",
    "Raises holder's Defense by 1 stage after it is hit by a physical attack. Single use.":"受到物理招式攻击时，防御提升1级，使用后消失",
    "Raises holder's Defense by 1 stage when at 1/4 max HP or less. Single use.":"HP小于等于25%时提升1级防御，使用后消失",
    "Raises holder's Sp. Atk by 1 stage if hit by a Water-type attack. Single use.":"受到水属性招式攻击时特攻提升1级，使用后消失",
    "Raises holder's Sp. Atk by 1 stage when at 1/4 max HP or less. Single use.":"HP小于等于25%时特攻提升1级，使用后消失",
    ...
    "Raises holder's Sp. Def by 1 stage when at 1/4 max HP or less. Single use.":"HP小于等于25%时特防提升1级，使用后消失",
    ...
    "Raises holder's Speed by 1 stage when at 1/4 max HP or less. Single use.":"HP小于等于25%时速度提升1级，使用后消失",
    "Restores 1/4 max HP after holder is hit by a supereffective move. Single use.":"受到效果绝佳的攻击时回复1/4最大HP，使用后消失",
    "Restores 1/4 max HP when at 1/2 max HP or less. Single use.":"HP小于等于50%时回复1/4最大HP，使用后消失",
    "Restores 10 HP when at 1/2 max HP or less. Single use.":"HP小于等于50%时回复10HP，使用后消失",
    "Restores 10 PP to the first of the holder's moves to reach 0 PP. Single use.":"招式的PP降到0时恢复该招式10点PP，使用后消失",
    "Restores 20 HP when at 1/2 max HP or less. Single use.":"HP小于等于50%时回复20HP，使用后消失",
    "Restores 33% max HP at 1/4 max HP or less; confuses if -Atk Nature. Single use.":"HP小于等于25%时回复33%最大HP，减攻击性格会陷入混乱，使用后消失",
    "Restores 33% max HP at 1/4 max HP or less; confuses if -Def Nature. Single use.":"HP小于等于25%时回复33%最大HP，减防御性格会陷入混乱，使用后消失",
    "Restores 33% max HP at 1/4 max HP or less; confuses if -SpA Nature. Single use.":"HP小于等于25%时回复33%最大HP，减特攻性格会陷入混乱，使用后消失",
    "Restores 33% max HP at 1/4 max HP or less; confuses if -SpD Nature. Single use.":"HP小于等于25%时回复33%最大HP，减特防性格会陷入混乱，使用后消失",
    "Restores 33% max HP at 1/4 max HP or less; confuses if -Spe Nature. Single use.":"HP小于等于25%时回复33%最大HP，减速度性格会陷入混乱，使用后消失",
    "Restores 50 HP to one Pokemon but lowers Happiness.":"回复60HP但是会降低亲密度",
    "Restores all lowered stat stages to 0 when one is less than 0. Single use.":"将所有能力阶级小于等于0的能力都恢复至0，使用后消失",
    "Solgaleo or Dusk Mane Necrozma with Sunsteel Strike can use a special Z-Move.":"索尔迦雷欧/奈克洛兹玛-黃昏之鬃可以将流星闪冲转化成Z招式：日光回旋下苍穹",
    "The accuracy of attacks against the holder is 0.9x.":"对手命中率降低10%",
    "The accuracy of attacks by the holder is 1.1x.":"命中率提升10%",
    "The accuracy of attacks by the holder is 1.2x if it moves after its target.":"比目标行动慢时命中率提升20%",
    ...
    "Restores 1/2 max HP at 1/4 max HP or less; confuses if -Atk Nature. Single use.":"HP小于等于25%时回复1/2最大HP，减攻击性格会陷入混乱，使用后消失",
    "Restores 1/2 max HP at 1/4 max HP or less; confuses if -Def Nature. Single use.":"HP小于等于25%时回复1/2最大HP，减防御性格会陷入混乱，使用后消失",
    "Restores 1/2 max HP at 1/4 max HP or less; confuses if -Spe Nature. Single use.":"HP小于等于25%时回复1/2最大HP，减速度性格会陷入混乱，使用后消失",
    "Restores 1/2 max HP at 1/4 max HP or less; confuses if -SpA Nature. Single use.":"HP小于等于25%时回复1/2最大HP，减特攻性格会陷入混乱，使用后消失",
        
    // Gen 2 Items
        
    "(Gen 2) On switch-in, raises holder's Attack by 2 and confuses it. Single use.":"（第二世代限定）出场时陷入混乱并提升两级攻击，使用后消失",
    "(Gen 2) Restores 10 HP when at 1/2 max HP or less. Single use.":"（第二世代限定）HP小于等于50%时回复10HP，使用后消失",
    ...
    "(Gen 2) Restores 30 HP when at 1/2 max HP or less. Single use.":"（第二世代限定）HP小于等于50%时回复30HP，使用后消失",
