    ...
    "Restores 20 HP when at 1/2 max HP or less. Single use.":"HP低于50%时回复20HP，使用后消失",
    "Restores 33% max HP at 1/4 max HP or less; confuses if -Atk Nature. Single use.":"HP低于25%时回复33%最大HP，减攻击性格会陷入混乱，使用后消失",
    "Restores 33% max HP at 1/4 max HP or less; confuses if -Def Nature. Single use.":"HP低于25%时回复33%最大HP，减防御性格会陷入混乱，使用后消失",
    "Restores 33% max HP at 1/4 max HP or less; confuses if -SpA Nature. Single use.":"HP低于25%时回复33%最大HP，减特攻性格会陷入混乱，使用后消失",
    "Restores 33% max HP at 1/4 max HP or less; confuses if -SpD Nature. Single use.":"HP低于25%时回复33%最大HP，减特防性格会陷入混乱，使用后消失",
    "Restores 33% max HP at 1/4 max HP or less; confuses if -Spe Nature. Single use.":"HP低于25%时回复33%最大HP，减速度性格会陷入混乱，使用后消失",
    "Restores 50 HP to one Pokemon but lowers Happiness.":"回复60HP但是会降低亲密度",
    "Restores all lowered stat stages to 0 when one is less than 0. Single use.":"将所有能力阶级低于0的能力都恢复至0，使用后消失",
    ...
    // Gen 7
    "Restores 1/2 max HP at 1/4 max HP or less; confuses if -SpD Nature. Single use.":"HP低于25%时回复1/2最大HP，减特防性格会陷入混乱，使用后消失",
    "Restores 1/2 max HP at 1/4 max HP or less; confuses if -Atk Nature. Single use.":"HP低于25%时回复1/2最大HP，减攻击性格会陷入混乱，使用后消失",
    "Restores 1/2 max HP at 1/4 max HP or less; confuses if -Def Nature. Single use.":"HP低于25%时回复1/2最大HP，减防御性格会陷入混乱，使用后消失",
    "Restores 1/2 max HP at 1/4 max HP or less; confuses if -Spe Nature. Single use.":"HP低于25%时回复1/2最大HP，减速度性格会陷入混乱，使用后消失",
    "Restores 1/2 max HP at 1/4 max HP or less; confuses if -SpA Nature. Single use.":"HP低于25%时回复1/2最大HP，减特攻性格会陷入混乱，使用后消失",
