    ...
    "After KOing a Pokemon: becomes Ash-Greninja, Water Shuriken: 20 power, hits 3x.":"击倒对方一只宝可梦后变身为小智版甲贺忍蛙，飞水手里剑威力变20，固定命中3次",
    ...
    "If Hail is active, this Pokemon's evasiveness is 1.25x; immunity to Hail.":"冰雹天气下闪避率提升25%；免疫冰雹伤害",
    ...
    "If Sandstorm is active, this Pokemon's evasiveness is 1.25x; immunity to Sandstorm.":"沙暴天气下闪避率提升25%；免疫沙暴伤害",
    "If Sunny Day is active, this Pokemon cannot be statused and Rest will fail for it.":"大晴天和大日照天气下不会陷入异常状态，使用睡觉会无效",
    "If Sunny Day is active, this Pokemon's Sp. Atk is 1.5x; loses 1/8 max HP per turn.":"大晴天天气下特攻提升50%；大晴天天气下回合结束时损失1/8最大HP",
    ...
    "If this Pokemon is statused, its Defense is 1.5x.":"异常状态下防御提升50%",
    "If this Pokemon is statused, its Speed is 1.5x; ignores Speed drop from paralysis.":"异常状态下速度提升50%，无视麻痹带来的速度降低影响",
    ...
    "On switch-in, this Pokemon's Attack is raised by 1 stage.":"出场时，攻击提升1级",
    "On switch-in, this Pokemon's Defense is raised by 1 stage.":"出场时，防御提升1级",
    ...
    "Prevents other Pokemon from lowering this Pokemon's Defense stat stage.":"防御不会被降低",
    ...
    "This Pokemon is healed 1/4 by Water, 1/8 by Rain; is hurt 1.25x by Fire, 1/8 by Sun.":"受到水属性招式攻击时回复1/4最大HP，受到的火属性伤害提升25%；下雨天气每回合回复1/8最大HP，大晴天损失1/8最大HP",
    ...
    "This Pokemon's Speed is raised by 6 stages after it is damaged by Fire/Water moves.":"受到火/水属性的招式攻击后，速度提升6级",
    ...
    "This Pokemon's accuracy can't be lowered by others; ignores their evasiveness stat.":"命中率不会被降低，无视对方闪避率阶级",
    "This Pokemon's allies have the base power of their moves multiplied by 1.3.":"该特性的宝可梦和在场同伴招式威力提升30%",
    "This Pokemon's allies have the power of their special attacks multiplied by 1.3.":"我方场上所有宝可梦使用特殊招式的威力提升30%",
    ...
    "This Pokemon's damaging moves hit twice. The second hit has its damage quartered.":"攻击两次；第2次攻击伤害变为第一次的1/4",
    ...
    "This Pokemon's moves of 60 power or less have 1.5x power. Includes Struggle.":"使用威力小于等于60的招式时威力提升50%，挣扎除外",
    "This Pokemon's multi-hit attacks always hit the maximum number of times.":"使用连续招式时，攻击次数会固定在5次",
    "This Pokemon's pulse moves have 1.5x power. Heal Pulse heals 3/4 target's max HP.":"波动类和波导类招式威力提升50%，治愈波动围边回复3/4最大HP",
