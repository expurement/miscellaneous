...
var translations={
    ...
    "Dragapult":"多龙巴鲁托",
    "Zacian":"苍响",
    "Zacian-Crowned":"苍响-剑之王形态",
    "Zamazenta":"藏玛然特",
    "Zamazenta-Crowned":"藏玛然特-盾之王形态",
    "Eternatus":"无极汰那",
    ...
    "10% chance to lower the target's Speed by 1.":"有10%的几率使目标的速度下降一级。",
     ...
     "Fighting, Normal hit Ghost. Evasiveness ignored.":"格斗系，一般系技能能击中幽灵系。无视回避率变化。",
    ...
    "Lowers Speed of all Pokémon except itself when hit by an attack.":"被攻击后，降低除自己以外的所有宝可梦的速度",
    "Prevents Explosion/Mind Blown/Self-Destruct/Aftermath while this Pokemon is active.":"该特性会使自爆、大爆炸和惊爆大头会使用失败，引爆特性不发动",
    "Boosts the Pokémon's Defense stat when the Pokémon enters a battle.":"出场时，防御会上升",
    "Boosts the Pokémon's Attack stat when the Pokémon enters a battle.":"出场时，攻击会上升",
    "Boosts the Pokémon's Attack stat but only allows the use of the first selected move.":"攻击获得提升，只能使用上场后使出的第一个招式",
    ...
    "Pokémon's head functions as substitute for a physical attack. Restored in hail.":"头部的冰会代替自己承受物理攻击，样子也会改变，下冰雹时恢复原状",
    "The Pokémon is protected by ice scales, which halve the damage taken from special moves.":"受到特殊攻击的伤害减半",
    "Changes the Pokémon's type depending on the terrain.":"宝可梦的属性会随着场地变化而变化",
    "If an active ally has this Ability or the Plus Ability, this Pokemon's Sp. Atk is 1.5x.":"场上己方同伴具有负电或正电特性时，特攻变为1.5倍",
    "Bounces back only the stat-lowering effects that the Pokémon receives.":"只反弹自己受到的能力降低效果",
    ...
    "Protects the Pokémon and its ally Pokémon from being poisoned.":"自己和同伴都不会陷入中毒的异常状态",
    "When hit by a contact move, the Pokémon and the attacker faint in 3 turns.":"受到接触攻击时，3回合后攻击者和自身都会倒下，交换解除效果",
    "If an active ally has this Ability or the Minus Ability, this Pokemon's Sp. Atk is 1.5x.":"场上己方同伴具有负电或正电特性时，特攻变为1.5倍",
    "Just being next to the Pokémon powers up moves.":"只要处在相邻位置，招式威力就会提高",
    "Ignores the effects of opposing Pokémon's Abilities and moves that draw in moves.":"能无视具有吸引对手招式效果的特性或招式的影响",
    ...
    "The Pokémon creates a sandstorm when it's hit by an attack.":"受到攻击时使天气变为沙暴",
    ...
    "Powers up ally Pokémon's Steel-type moves.":"自身和同伴的钢属性招式威力都会提升",
    ...
    "Exchanges abilities when hitting a Pokémon with a contact move.":"受到接触攻击时，与攻击方交换特性",
