...
var translations={
    ...
    "(Idle)":"闲置",
    "Genderless":"无性别",
    "Ladder updating...":"天梯积分更新中...",
    "Your replay has been uploaded! It's available at:":"你的录像已经上传成功，地址如下：",
    "Ladder (probably) updated, but score could not be retrieved (Response not received).":"天梯积分应该已经更新，但是数据暂时无法获取（无响应）",
    "Sort:":"排序方式",
