     ...
     "10% chance to burn the target. Thaws user.":"10%使目标灼伤，让使用者解除冰冻状态",
     ...
     "30% chance to burn the target. Thaws target.":"30%使目标灼伤，让使用者解除冰冻状态",
     ...
     "50% chance to burn the target. Thaws user.":"50%使目标灼伤，让使用者解除冰冻状态",
     ...
     "Lowers target's Attack, Sp. Atk by 2. User faints.":"使目标的攻击和特攻降低2级，使用者陷入濒死状态",
     "Lowers the foe(s) Attack by 1.":"使（所有）对手的攻击降低1级",
     "Lowers the foe(s) Defense by 1.":"使（所有）对手的防御降低1级",
     "Lowers the foe(s) Sp. Atk by 2 if opposite gender.":"如果目标的性别和使用者相反，目标的特攻降低2级",
     "Lowers the target's Attack and Sp. Atk by 1.":"降低目标的攻击和特攻1级",
     "Lowers the target's Attack by 2.":"使目标的攻击降低2级",
     "Lowers the target's HP to the user's HP.":"使目标的HP降得和使用者的HP相同",
     "Lowers the target's Sp. Atk by 1.":"使目标的特攻降低1级",
     "Lowers the target's Sp. Atk by 2.":"降低目标的特攻2级",
     "Lowers the target's Sp. Def by 2.":"使目标的特防降低2级",
     "Lowers the target's Speed by 2.":"使目标的速度降低2级",
     "Lowers the target's accuracy by 1.":"使目标的命中率降低1级",
     "Lowers the user's Defense and Sp. Def by 1.":"使使用者的防御和特防降低1级",
     "Lowers the user's Defense by 1.":"使目标的防御降低1级",
     "Lowers the user's Sp. Atk by 2.":"使使用者的特攻降低2级",
     "Lowers the user's Speed by 1.":"使使用者的速度降低1级",
     ...
     "Power doubles if a foe is switching out.":"如果对手替换宝可梦，威力为原来的2倍",
     ...
     "Power doubles if user is burn/poison/paralyzed.":"如果使用者处于灼伤/中毒/麻痹状态，招式威力为原来的2倍",
     ...
     "Raises the target's Sp. Atk by 1 and confuses it.":"使目标的特攻提升1级，使目标陷入混乱状态",
     "Raises the user's Attack and Defense by 1.":"提升使用者的供给和防御各1级",
     "Raises the user's Attack and Speed by 1.":"提升使用者的攻击和速度各1级",
     "Raises the user's Attack and accuracy by 1.":"使使用者的攻击和命中率提升1级",
     "Raises the user's Attack by 1 if hit during use.":"如果在使用招式时受到攻击，使用者的攻击提升1级",
     "Raises the user's Attack by 1.":"使使用者的攻击提升1级",
     ...
     "Raises the user's Sp. Atk by 2.":"使使用者的特攻提升2级",
     "Raises the user's Sp. Atk, Sp. Def, Speed by 1.":"提升使用者的特攻特防速度各1级",
     "Raises the user's critical hit ratio by 2.":"使使用者的击中要害阶级提升2级",
     "Raises the user's evasiveness by 1.":"使使用者的闪避率提升以1级",
     "Raises the user's evasiveness by 2.":"使使用者的闪避率提升2级",
     "Raises user's Atk, Def, SpA, SpD, and Spe by 2.":"提升使用者的攻击防御特攻特防速度各2级",
     "Raises user's Attack and Sp. Atk by 1; 2 in Sun.":"让使用者的攻击和特攻提升1级，大晴天提升2级",
    ...
    "10% chance to raise the user's Defense by 1.":"10%使使用者的防御提升1级",
    ...
    "Raises the user's Attack by 2.":"使使用者的攻击提升2级",
