    ...
    "10% chance to lower the target's Speed by 1.":"有10%的几率使目标的速度下降一级",
     ...
     "Raises Defense by 1 of all active Grass types.":"使场上所有草属性宝可梦的防御提升一级",
     ...
     "Raises user's Attack and Sp. Atk by 1; 2 in Sun.":"让使用者的攻击和特攻上升一级，大晴天上升两级",
     ...
     "Lowers target's Atk, Sp. Atk by 1. User switches.":"降低目标的攻击和特攻一级，使用者和后备宝可梦替换",
     ...
     "+ 20 power for each of the user's stat boosts.":"每上升一级能力招式威力增加20点",
     ...
     "Raises the user's Attack by 1 if hit during use.":"如果在使用招式时受到攻击，使用者的攻击上升一级",
    ...
    "100% chance to lower the target's Sp. Def by 1.":"降低目标一级特防",
    "Morpeko: Electric; Hangry: Dark; 100% +1 Spe.":"提升一级速度，在满腹花纹时会变成电属性招式，空腹花纹时则为恶属性招式",
    ...
    "100% chance to lower adjacent foes' Atk by 1.":"降低对手全体一级攻击",
    "100% chance lower adjacent Pkmn Speed by 1.":"令目标的速度降低一级",
    "100% chance to paralyze the foe.":"令对手麻痹",
    "+1 SpD, user's Electric move next turn 2x power.":"提升一级特防，下一回合电属性招式威力2倍",
    "User loses 33% max HP. Raises all stats by 1.":"损失33%最大HP，提升所有能力一级",
    "Resets all of the target's stat stages to 0.":"使用者所有能力阶级归零",
    "Raises user's Attack, Defense, accuracy by 1.":"攻击，防御，命中提升一级",
    "Nullifies the foe(s) Ability if the foe(s) move first.":"如果目标在该回合已使用过招式，使目标陷入无特性状态",
    "Switches sides of field effects":"交换双方场地的状态效果",
    "Curses if Ghost, else -1 Spe, +1 Atk, +1 Def.":"非幽灵属性使用者则速度降低一级，攻击防御提升一级，否则减少1/2最大HP，使目标进入诅咒状态",
    "Darkrai: Causes the foe(s) to fall asleep.":"使对方全体陷入睡眠状态，仅在使用者为达克莱伊时奏效",
    "Raises the target's Atk and Sp. Atk by 2.":"提升使用者攻击和特攻二级",
    ...
    "Raises the user's and ally's Attack by 1.":"使用者和同伴的攻击提升一级",
    "Hoopa-U: Lowers user's Def by 1; breaks protect.":"使用者自身防御降低一级，无视守住状态，仅在使用者为解放胡帕时奏效",
    ...
    "Protects from attacks. Contact: lowers Atk by 1.":"完全抵挡对手的攻击。如果对手使用了接触类招式，攻击降低一级",
    ...
    "Raises all stats by 1 (not acc/eva). Traps user.":"所有能力提升一级，目标无法交换",
    "Protects from attacks. Contact: lowers Def by 2.":"抵挡对手的攻击。如果对手使用了接触类招式，防御降低二级",
    ...
    "Free user from hazards/bind/Leech Seed; +1 Spe.":"提升一级速度，移除己方场地上的撒菱、隐形岩、毒菱和黏黏网；摆脱自身束缚，寄生种子状态",
    "Raises Atk/Sp. Atk of grounded Grass types by 1.":"所有的地面上的草属性宝可梦的攻击，特攻提升一级",
    ...
    "Consumes berry and raises the user's Def. by 2.":"食用树果并且提升使用者防御二级",
    ...
    "Lowers the foe(s) evasiveness by 2.":"降低目标闪避率二级",
    "Target gets -1 Spe and becomes weaker to Fire.":"目标速度降低一级并且增加火属性弱点",
    ...
    "Lowers Atk/Sp. Atk/Speed of poisoned foes by 1.":"令中毒的目标的攻击，特攻，速度降低一级",
    ...
    "Foe(s): -1 evasion. BP scales with base move's BP.":"降低对手的闪避率一级，根据原有招式的威力决定极巨招式的威力",
    ...
    "Protects from attacks. Contact: lowers Atk by 2.":"抵挡对手的攻击。如果对手使用了接触类招式，攻击降低二级",
