     "+ 20 power for each of the user's stat boosts.":"能力阶级每上升1级招式威力增加20点",
     "-1 evasion; clears user and target side's hazards.":"目标闪避率降低1级，移除双方的钉子和对方的白雾、光墙、反射壁、极光幕和神秘守护",
     "1.5x damage if foe holds an item. Removes item.":"目标持有道具的话，招式威力为原来的1.5倍，移除目标的道具",
     ...
     "10% chance to burn the target.":"10%几率使目标陷入灼伤状态",
     "10% chance to burn. 10% chance to flinch.":"10%的几率使目标陷入灼伤状态，10%几率使目标畏缩",
     "10% chance to confuse the target.":"10%几率使目标陷入混乱状态",
     "10% chance to freeze the foe(s).":"10%几率使目标陷入冰冻状态",
     "10% chance to freeze the target.":"10%几率使目标陷入冰冻状态",
     "10% chance to freeze. 10% chance to flinch.":"10%几率使目标陷入冰冻状态，10%几率使目标畏缩",
     "10% chance to freeze. Super effective on Water.":"10%几率使对手陷入冰冻状态，对水属性效果绝佳",
     "10% chance to lower the target's Attack by 1.":"10%几率使目标的攻击降低1级",
     "10% chance to lower the target's Sp. Def by 1.":"10%几率使目标的特防降低1级",
     "10% chance to raise the user's Attack by 1.":"10%几率使使用者的攻击提升1级",
     "10% chance to sleep foe(s). Meloetta transforms.":"10%使目标陷入睡眠状态，梅洛耶塔使用后能够变换形态",
     "100% chance to burn the target.":"100%使目标陷入灼伤状态",
     "100% chance to confuse the target.":"100%使目标混乱",
     "100% chance to lower the foe(s) Speed by 1.":"100%使目标的速度降低1级",
     "100% chance to lower the target's Attack by 1.":"100%使目标的攻击降低1级",
     "100% chance to lower the target's Defense by 1.":"100%使目标的防御降低1级",
     "100% chance to lower the target's Sp. Atk by 1.":"100%使目标的特攻降低1级",
     "100% chance to lower the target's Speed by 1.":"100%使目标的速度降低1级",
     "100% chance to lower the target's accuracy by 1.":"100%使目标的命中率降低1级",
     "100% chance to raise the user's Attack by 1.":"100%使使用者的攻击提升1级",
     "100% chance to raise the user's Speed by 1.":"100%使使用者的速度提升1级",
     "20% chance to confuse the target.":"20%几率使目标陷入混乱状态",
     "20% chance to flinch the target.":"20%几率使目标畏缩",
     "20% chance to lower the target's Defense by 1.":"20%几率使目标的防御降低1级",
     "20% chance to raise the user's Attack by 1.":"20%几率使使用者的攻击提升1级",
     "30% chance to burn adjacent Pokemon.":"30%几率使邻近的宝可梦陷入灼伤状态",
     "30% chance to burn the target. Thaws target.":"30%几率使目标陷入灼伤状态，让使用者解除冰冻状态",
     "30% chance to confuse target. Can't miss in rain.":"30%几率使目标混乱，在雨天不能被闪避",
     "30% chance to flinch the foe(s).":"30%几率使目标畏缩",
     "30% chance to lower the foe(s) accuracy by 1.":"30%几率使目标的命中率降低1级",
     "30% chance to lower the target's Defense by 1.":"30%几率使目标的防御降低1级",
     "30% chance to lower the target's Sp. Atk by 1.":"30%几率使目标的特攻降低1级",
     "30% chance to lower the target's accuracy by 1.":"30%几率使目标的命中率降低1级",
     "30% chance to paralyze adjacent Pokemon.":"30%几率使邻近的宝可梦陷入麻痹状态",
     "30% chance to poison the target.":"30%几率使目标陷入中毒状态",
     "40% chance to lower the target's accuracy by 1.":"40%几率使目标的命中率降低1级",
     "5 turns. Can't status,-Dragon power vs grounded.":"5回合内，地面上的宝可梦不会陷入异常及混乱状态，受到龙属性招式的伤害减半",
     "5 turns. Grounded: +Electric power, can't sleep.":"5回合内，地面上的宝可梦使用电属性招式威力x1.5，不能陷入睡眠状态",
     "5 turns. Grounded: +Psychic power, priority-safe.":"5回合内，地面上的宝可梦使用超能力属性招式威力x1.5，不会受到先制招式攻击",
     "50% chance to badly poison the target.":"50%几率使目标陷入中剧毒状态",
     "50% chance to burn the target. Thaws user.":"50%几率使目标陷入灼伤状态，让使用者解除冰冻状态",
     "50% chance to lower the target's Defense by 1.":"50%几率使目标的防御降低1级",
     "50% chance to lower the target's Sp. Atk by 1.":"50%几率使目标的特攻降低1级",
     "50% chance to lower the target's Sp. Def by 1.":"50%几率使目标的特防降低1级",
     "50% chance to lower the target's accuracy by 1.":"50%几率使目标的命中率降低1级",
     "50% chance to raise the user's Sp. Atk by 1.":"50%几率使使用者的特攻提升1级",
     "50% chance to raise user's Def by 2 for each hit.":"50%几率使使用者的防御提升2级",
     "60 power +20 for each of the target's stat boosts.":"威力为60+20×目标上升的能力阶级的总和",
     "70% chance to raise the user's Sp. Atk by 1.":"70%几率使使用者的特攻提升1级",
      //////////////////////////////////////////////////////////////////////
     ...
     "Charges, then raises SpA, SpD, Spe by 2 turn 2.":"先充能，然后提升使用者的特攻特防速度各2级",
     ...
     "For 5 turns, heavy rain powers Water moves.":"5回合内，大雨提升水属性招式的威力",
     "For 5 turns, negates all Ground immunities.":"5回合内无视所有对地上属性的免疫",
