    ...
    "User switches, passing stat changes and more.":"使用者和后备宝可梦替换，能够接力能力等级变化等",
    "Burns on contact with the user before it moves.":"在使用招式前接触到使用者的对手会陷入烧伤状态",
    ...
    "10% chance to lower the target's Speed by 1.":"有10%的几率使目标的速度下降一级",
     ...
     "Power doubles if user is burn/poison/paralyzed.":"如果使用者处于烧伤/中毒/麻痹状态，招式威力为原来的两倍",
     ...
     "Protects allies from priority attacks this turn.":"保护同伴免收先制招式攻击",
    ...
    "Usually goes first. Fails if target is not attacking.":"一定能先发制人进行攻击如果目标不使用攻击招式的话则使用失败",
